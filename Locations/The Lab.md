...
A width-long room with other smaller rooms with cryogenic pods for each human player (four rooms at least, even with three or less human players). Each smaller room has a cryogenic pod, and a desk with a chair. The game manager can include items on the desk. In the middle of the compartment is a door to exit into another compartment.

### Forest

A length-long room with most width taken by various plant life (mostly trees). White Latex and small White Latex creatures can escape from vents. At the end of the compartment is a door to exit to another compartment.
